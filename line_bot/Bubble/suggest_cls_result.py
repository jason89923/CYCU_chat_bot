def suggest_cls_result_card(search_res):
                    ...
                    "contents": [
                        {
                            ...
                            "action": {
                                "type": "message",
                                "label": "追蹤課程",
                                "text": "將" + check_follow(search_res['teacher_cname']) + search_res['op_code'] + "加入追蹤清單"
                            }
                        }
                    ],
                    "width": "25%",
...
def make_body_content(search_res):
    ...
    if 'op_time_2' in search_res.keys() and search_res['op_time_2'] is not None:
        content += [{
            "type": "box",
            "layout": "horizontal",
            "contents": [
    ...
    if 'op_time_3' in search_res.keys() and search_res['op_time_3'] is not None:
        content += [{
            "type": "box",
            "layout": "horizontal",
            "contents": [
